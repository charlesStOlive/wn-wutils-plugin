...
class ExcelTrad extends GeneratorCommand
{
    ...
    protected function createExcel() {
        ...
        \Excel::store(new \Waka\Wutils\Classes\Exports\ExportAll($allLanfFiles, $this->arrayLangs ), $this->getExcelFileName());
    }
    ...
    protected function importExcel() {
        ...
        $importExcel = new \Waka\Wutils\Classes\Imports\ImportLang($langFiles, $this->arrayLangs);
