...
class DuplicateModel extends ControllerBehavior
{
    ...
    public function onLoadDuplicateForm()
    {
        ...
        return $this->makePartial('$/waka/wutils/behaviors/duplicatemodel/_duplicate_form.htm');
    }
    ...
    public function onLoadDuplicateContentForm()
    {
        ...
        $this->vars['modelId'] = post('modelId');
        return [
            '#popupActionContent' => $this->makePartial('$/waka/wutils/behaviors/duplicatemodel/_duplicate_content.htm'),
        ];
    }
